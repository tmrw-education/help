...
1. Navigate to **Academic management** ▸ **Students** ▸ **All students**.
2. OR: If using Fee payer as the customer: Click **Academic management** ▸ **Fee payer**.
