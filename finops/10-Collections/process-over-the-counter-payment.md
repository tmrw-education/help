---
id: process-over-the-counter-payment
summary:
  - "Open **Accounts receivable ▸ Payments ▸ Over the counter payment**, click **Create New Customer Payment**, select the fee payer, mark the invoices, enter the payment method and amount, then Post."
  - "If the payment exceeds the invoice total, the system automatically ticks Pay in Advance and records the excess as an advance."
keywords: [over the counter payment, cashier payment, fee payer payment, post payment, advance payment, receipt]
video:
  youtube:
  bunny:
---
