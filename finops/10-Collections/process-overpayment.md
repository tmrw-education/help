...
keywords: [overpayment, cashier receipt overpayment, excess payment, advance, overpayment field, cashier form]
video:
  youtube:
  bunny:
---
...
1. Create the cashier receipt
   ...
   ![Process an Overpayment — the Cashier receipt form with an amount greater than the invoice total entered and the Overpayment field showing the excess](./images/process-overpayment-1.png)

   ![Process an Overpayment — the Post receipt dialog with the Print receipt toggle](./images/process-overpayment-2.png)
