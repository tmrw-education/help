---
id: process-fee-refund
summary:
  - "Create a customer payment journal using the **Customer refund journal** name, select the student account, choose the refund method, click **Settle transactions** to find the credit invoice, set financial dimensions, then Post."
  - "Proceed only after confirming bank details. If a workflow is active, submit for approval before posting."
keywords: [fee refund, credit balance refund, customer refund journal, settle transactions refund, financial dimensions refund, refund credit balance]
video:
  youtube:
  bunny:
---
