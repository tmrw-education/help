---
id: process-outstanding-payment
summary:
  - "Open **Accounts receivable ▸ Payments ▸ Cashier receipt**, click **+ Cashier receipt**, enter the student account, tick the invoice, select the method of payment, enter the amount, then Post."
keywords: [outstanding payment, cashier receipt, process payment, overdue invoice, post cashier receipt, cashier form]
video:
  youtube:
  bunny:
---
...
1. Create the cashier receipt
   ...
   ![Process an Outstanding Payment — the + Cashier receipt button highlighted in the Action Pane](./images/process-outstanding-payment-1.png)

   ![Process an Outstanding Payment — the Cashier receipt form with the student account, invoice ticked, Method of payment, and Amount fields](./images/process-outstanding-payment-2.png)
