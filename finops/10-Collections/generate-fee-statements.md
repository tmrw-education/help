---
id: generate-fee-statements
summary:
  - "Open **Academic Management ▸ Inquiries and reports ▸ Fee payer statement report ▸ Fee payer account statement**, enter the date range, optionally filter for the account, and click OK."
keywords: [fee payer statement, fee statements, account statement, generate statement, outstanding invoices, fee payer account statement]
video:
  youtube:
  bunny:
---
...
1. Open Fee payer account statement and set parameters
   ...
   ![Generate Fee Statements in Bulk — the Fee payer account statement dialog with date range and Records to include filter](./images/generate-fee-statements-1.png)
