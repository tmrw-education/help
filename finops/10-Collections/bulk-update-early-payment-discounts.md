---
id: bulk-update-early-payment-discounts
summary:
  - "Run **Academic Management ▸ Periodic tasks ▸ Update early payment discount**, set the date range and early payment date, and click OK."
  - "Then verify in **Accounts receivable ▸ Invoices ▸ Open Customer Invoices** that discounts and due dates are updated."
keywords: [bulk update discount, early payment discount bulk, update early payment discount, periodic task discount, invoice discount update]
video:
  youtube:
  bunny:
---
