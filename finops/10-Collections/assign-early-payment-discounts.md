---
id: assign-early-payment-discounts
summary:
  - "Open the fee item in **Product information management ▸ Products ▸ Released products**, expand the **Sell** section, and assign the relevant early payment discount code, then save."
  - "Used for the Advance Discount Payment — Date Based setup."
keywords: [early payment discount, assign discount, discount to product, fee item discount, released products sell, date-based discount]
video:
  youtube:
  bunny:
---
