---
id: process-activity-invoice-payment
summary:
  - "Open **Accounts Receivable ▸ Payments ▸ Cashier receipt**, click **+ Cashier receipt**, select the student account, tick the activity invoice, enter the amount and method, then Post."
keywords: [activity invoice payment, cashier receipt activity, activity fee payment, sessional invoice, cashier form]
video:
  youtube:
  bunny:
---
