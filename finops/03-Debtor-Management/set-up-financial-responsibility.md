---
id: set-up-financial-responsibility
summary:
  - "In the student record's **Relationships** section, confirm at least two fee payers are assigned with split percentages that total 100%."
  - "If Fee Payer is managed as a customer, financial responsibility is set in the Student Management System and synchronised to D365 F&O — the steps below show how to view that setup."
keywords: [financial responsibility, split billing, fee payer, paid percentage, split percentage, student financial setup]
video:
  youtube:
  bunny:
---
...
![Student Setup Financial Responsibility — split percentage detail showing two fee payers each set to 50%](./images/set-up-financial-responsibility-2.png)
