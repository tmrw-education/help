---
id: end-of-day-procedure
summary:
  - "Consolidate open deposit slips by payment method from **Accounts receivable ▸ Workspaces ▸ Customer payments ▸ Consolidate deposit slip**."
  - "Generate a **Deposit slip report** filtered by the consolidated deposit slip number, then verify the deposit as a single transaction on the bank account."
keywords: [end of day, deposit slip, consolidate deposit, cashier close, bank reconciliation, day-end procedure]
video:
  youtube:
  bunny:
---
...
2. Consolidate deposit slips
   ...
   ![End of Day Procedure — the Consolidate deposit slip form with date range and Method of payment filter](./images/end-of-day-procedure-2.png)

   ![End of Day Procedure — the Deposit slips list showing the consolidated entry after consolidation](./images/end-of-day-procedure-3.png)
...
3. Generate the deposit slip report
   ...
   ![End of Day Procedure — the Deposit slip reports filter with the deposit slip number entered](./images/end-of-day-procedure-4.png)

   ![End of Day Procedure — the generated deposit slip report](./images/end-of-day-procedure-5.png)
   
   ![End of Day Procedure — the bank account Transactions view showing the consolidated deposit as a single amount](./images/end-of-day-procedure-6.png)
