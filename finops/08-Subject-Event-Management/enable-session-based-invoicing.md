---
id: enable-session-based-invoicing
summary:
  - "Open the fee schedule template in **All fee schedules** and enable the **Session Based** option, then Save."
  - "If Session Based is not enabled, the system charges a flat fee (quantity = 1). Delete any previously generated sales order before rerunning the fee generation batch."
keywords: [session based invoicing, sessions attended, flat fee, fee schedule session, sessional billing]
video:
  youtube:
  bunny:
---
