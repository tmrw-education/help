---
id: set-up-subject-and-event-names
summary:
  - "Open **Academic Management ▸ Setup ▸ Subject and event names** and click **New**."
  - "Enter the code, name, category, and item number, then Save."
keywords: [subject and event names, event setup, fee category, sessional class, event code, activity setup]
video:
  youtube:
  bunny:
---
