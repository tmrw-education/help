---
id: generate-session-adjustment
summary:
  - "Run **Academic Management ▸ Periodic tasks ▸ Generate sessional class and event adjustments**, enter the adjustment date, filter for the student if needed, and click OK."
  - "The system creates a new sales order reflecting the correct session count and adjusted amount."
keywords: [session adjustment, generate adjustment, sessional class adjustment, session billing adjustment, adjustment batch]
video:
  youtube:
  bunny:
---
