---
id: reverse-enrolment-deposit-or-fee
summary:
  - "In **All pre-admission fees**, filter by Status = **Posted**, select the deposit or fee, click **Cancel**, set the Reverse posting date, and click OK."
  - "The reversal creates an offsetting entry without deleting audit history."
keywords: [reverse enrolment deposit, reverse fee, cancel enrolment fee, reversal, posted fee reversal, unpaid fees]
video:
  youtube:
  bunny:
---
