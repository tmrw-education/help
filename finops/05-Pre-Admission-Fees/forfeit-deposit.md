...
id: forfeit-deposit
summary:
  - "In **Pre-admission deposits**, check the deposit, click **Forfeit**, choose Preview or auto-post, then open the forfeit journal and post the credit line."
  - "Only deposits with status **Received** or **Partial** are eligible to be forfeited."
keywords: [forfeit deposit, enrolment deposit forfeit, retain deposit, deposit forfeiture, pre-admission forfeit]
video:
  youtube:
  bunny:
---
