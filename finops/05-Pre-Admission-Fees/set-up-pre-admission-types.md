---
id: set-up-pre-admission-types
summary:
  - "Open **Academic Management ▸ Setup ▸ Pre-admission fees ▸ Pre-admission types** and click **New**."
  - "Enter the **Pre-admission type**, **Description**, and tick **Deposit** if the type represents an enrolment deposit."
  - "Click **Save**. Pre-admission types must be created before posting rules can be configured."
keywords: [pre-admission type, admission type setup, enrolment deposit type, application fee type, pre-admission setup]
video:
  youtube:
  bunny:
---
