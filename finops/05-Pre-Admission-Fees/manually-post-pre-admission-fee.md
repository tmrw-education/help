---
id: manually-post-pre-admission-fee
summary:
  - "Filter **All pre-admission fees** by Application Fee, select the student record, click **Post** with **Preview = Yes**, and confirm the sales order number on the General tab."
  - "This step is only required for counter payments — online payments create the sales order automatically."
keywords: [manually post pre-admission fee, cashier receipt, counter payment, sales order, application fee manual, post pre-admission]
video:
  youtube:
  bunny:
---
