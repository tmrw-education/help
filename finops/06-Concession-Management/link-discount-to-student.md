---
id: link-discount-to-student
summary:
  - "Open **Academic Management ▸ Setup ▸ Scholarships and discounts** and select the discount code."
  - "Click **General**, choose **Students**, and click **New**."
  - "Select the student, set the **discount amount** and **dates**, then click **Save**."
keywords: [link discount student, scholarship student, discount student, attach student concession, apply scholarship student, link concession to student]
video:
  youtube:
  bunny:
---
