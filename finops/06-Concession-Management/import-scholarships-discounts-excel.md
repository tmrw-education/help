---
id: import-scholarships-discounts-excel
summary:
  - "Open **Scholarship and discount details**, click **Open in Microsoft Office**, and download the Excel template."
  - "Enable editing, wait for the add-in to sign in, then use **Design** to add all available fields."
  - "Enter or update records, then click **Publish**. Rows highlighted in red failed validation — correct and republish."
keywords: [import scholarship excel, bulk upload scholarships, excel add-in discount, scholarship discount import, bulk concession upload, TMRW data entity scholarship]
video:
  youtube:
  bunny:
---
