---
id: set-up-charge-code
summary:
  - "Open **Accounts Receivable ▸ Charges setup ▸ Auto charges** and set the **Level** to **Line**."
  - "Click **New**, enter the **Charge description**, and configure the charge settings."
  - "Click **Save**."
keywords: [set up charge code, auto charges, concession charge code, staff concession charge, charge code setup, accounts receivable charge]
video:
  youtube:
  bunny:
---
