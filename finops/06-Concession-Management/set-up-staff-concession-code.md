---
id: set-up-staff-concession-code
summary:
  - "Open **Academic Management ▸ Setup ▸ Scholarship and discount** and click **New**."
  - "Enter a name, select the **Type**, link the **Charge code**, and click **Activate**."
  - "Configure the **Approval** settings and click **Save**."
keywords: [staff concession code, staff concession setup, concession discount code, set up staff concession, commercial concession, corporate concession, scholarship discount type]
video:
  youtube:
  bunny:
---
