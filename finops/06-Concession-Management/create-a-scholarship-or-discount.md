---
id: create-a-scholarship-or-discount
summary:
  - "Open **Academic Management ▸ Setup ▸ Scholarships and discounts** and click **New**."
  - "Fill in the **Code**, **Name**, enable **Active** and **Approval**, and assign the **User group**."
  - "Link the code to the relevant **fee items** and **students**, entering the discount percentage and dates."
  - "Set the **Approval** status to **Report as ready**, then **Approve**, and click **Save**."
keywords: [create scholarship, create discount, scholarship setup, discount setup, scholarship code, discount code, concession code, approval group, fee discount, set up concession]
video:
  youtube:
  bunny:
---
...
2. Complete the discount code details
   ...
   ![Scholarship and discount setup — the new code form with Code, Name, Active, Approval, and User group fields](./images/create-a-scholarship-or-discount-1.png)
...
3. Create a new approval user group (if needed)
   ...
   ![Scholarship and discount setup — the User group dropdown and approval configuration](./images/create-a-scholarship-or-discount-2.png)

   ![Scholarship and discount setup — the General tab with the Items section open](./images/create-a-scholarship-or-discount-3.png)

   ![Scholarship and discount setup — a new fee item line being added under Items](./images/create-a-scholarship-or-discount-4.png)
...
4. Link fee items to the code
   ...
   ![Scholarship and discount setup — the Students tab with a new student record and the Discount %, Effective date, and Expiration date fields](./images/create-a-scholarship-or-discount-5.png)
...
5. Add a student and configure the discount
   ...
   ![Scholarship and discount setup — the Approval dropdown showing Report as ready and Approve options](./images/create-a-scholarship-or-discount-6.png)
