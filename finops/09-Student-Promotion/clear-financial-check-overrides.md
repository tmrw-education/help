---
id: clear-financial-check-overrides
summary:
  - "Add the **Financial check override** column to the All Students list view to identify students with an active override."
  - "Clear overrides individually by unchecking the column, or in bulk by exporting to Excel, clearing the values, and reimporting."
keywords: [clear financial check override, reset override, bulk clear, financial check, re-enrolment, excel import]
video:
  youtube:
  bunny:
---
