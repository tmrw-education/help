---
id: view-student-enrolment-dates
summary:
  - "Open the student record and confirm enrolment status shows **Re-enrolment open**."
  - "Click **Academic ▸ Academic enrolments** to verify both the current grade and next grade records are present."
  - "Do not edit the Academic enrolments table directly — records are managed by the Student Management System."
keywords: [student enrolment dates, academic enrolment, re-enrolment, promotion, academic year records]
video:
  youtube:
  bunny:
---
