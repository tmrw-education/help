---
id: recalculate-open-sales-order-prices
summary:
  - "Run **Academic Management ▸ Periodic tasks ▸ Recalculate Open Sales Order**, filter by student or sales order, set **Recalculate sales price = Yes**, and click OK."
  - "After a fee price change is posted, open proforma sales orders generated under the old price will not automatically update — this task re-prices those open orders."
keywords: [recalculate sales price, open sales order, price recalculation, fee change update, proforma reprice, periodic task]
video:
  youtube:
  bunny:
---
