---
id: settle-enrolment-deposits
summary:
  - "After posting fee invoices, open **Academic Management ▸ Inquiries and reports ▸ Pre-admission fees ▸ Pre-admission deposits**, click OK, and confirm deposit statuses have changed from **Received** to **Settled**."
keywords: [settle enrolment deposits, deposit settlement, enrolment deposit, deposit status, received to settled]
video:
  youtube:
  bunny:
---
...
![Settle Enrolment Deposits — the deposit sales order detail view](./images/settle-enrolment-deposits-2.png)

![Settle Enrolment Deposits — the Pre-admission deposits list with deposit status updated to Settled](./images/settle-enrolment-deposits-3.png)
