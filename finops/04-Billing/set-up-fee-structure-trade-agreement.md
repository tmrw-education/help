---
id: set-up-fee-structure-trade-agreement
summary:
  - "Create a trade agreement journal using the academic journal name in **Sales and marketing ▸ Prices and discounts ▸ Trade agreement journals**, add a monthly price line and an annual price line for each academic attribute combination, then Post."
  - "Each academic attribute combination (academic year + curriculum + stream) requires two trade agreement lines: one monthly (fee invoices) and one annual (deposit calculations)."
keywords: [fee structure, trade agreement, academic journal, tuition price, monthly price, annual price, academic attribute]
video:
  youtube:
  bunny:
---
...
2. Create the trade agreement journal and add price lines
   ...
   ![Set Up Fee Structure — Trade Agreement — the Released products form showing the tuition fee item before price setup](./images/set-up-fee-structure-trade-agreement-1.png)

   ![Set Up Fee Structure — Trade Agreement — the Trade agreement journal lines with a monthly and annual line per academic attribute combination](./images/set-up-fee-structure-trade-agreement-2.png)

   ![Set Up Fee Structure — Trade Agreement — the Post confirmation for the trade agreement journal](./images/set-up-fee-structure-trade-agreement-3.png)
