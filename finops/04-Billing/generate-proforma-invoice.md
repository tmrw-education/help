---
id: generate-proforma-invoice
summary:
  - "Find the student's sales order via **Academic Management ▸ Students ▸ All students ▸ Sell ▸ Orders ▸ All sales orders**, click **Sell ▸ Confirm sales order**, set Print confirmation and Use print management destination to Yes, then click OK."
  - "The system sends the proforma invoice to the fee payer using the print management destination configured for the school."
keywords: [proforma invoice, generate proforma, confirm sales order, print confirmation, print management destination, proforma document]
video:
  youtube:
  bunny:
---
