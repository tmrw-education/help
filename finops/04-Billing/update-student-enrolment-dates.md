---
id: update-student-enrolment-dates
summary:
  - "In **Academic Management ▸ Students ▸ All Students**, open the student record, go to **Academic ▸ Academic enrolments**, and update the Effective date to the actual start date."
  - "Critical changes such as enrolment dates can only be managed in the Student Management System, not directly in D365 F&O."
keywords: [update enrolment dates, effective date, student enrolment, enrolment date, late start, academic enrolment]
video:
  youtube:
  bunny:
---
