---
id: configure-split-billing-percent-by-fee-item
summary:
  - "Open **Academic Management ▸ Setup ▸ Split percent by fee items**, click **New**, and configure custom split percentages per student per fee item with effective and expiration dates."
  - "This configuration applies only to sales orders generated after saving — existing invoices are not affected."
keywords: [split billing percent, split percent by fee item, fee item split, billing split override, financial responsibility override]
video:
  youtube:
  bunny:
---
