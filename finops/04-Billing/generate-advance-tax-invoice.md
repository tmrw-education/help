---
id: generate-advance-tax-invoice
summary:
  - "Open the student's sales order via **All students ▸ Sell ▸ All sales orders**, click **Invoice ▸ Add prepayment invoice**, select the Mark checkbox, set the Sales category, then Post."
  - "Used when a family requests a formal tax invoice ahead of settlement — for example, for employer reimbursement or government funding."
keywords: [advance tax invoice, prepayment invoice, tax invoice request, advance tax, sales category, prepayment]
video:
  youtube:
  bunny:
---
