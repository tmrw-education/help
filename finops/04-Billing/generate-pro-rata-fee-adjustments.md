---
id: generate-pro-rata-fee-adjustments
summary:
  - "Run **Academic Management ▸ Periodic tasks ▸ Generate sales order batch processing** with the relevant fee schedule template, then review the batch to confirm late-starting students have a reduced tuition fee amount."
keywords: [pro rata fee adjustment, late joining, generate sales order batch, pro rata billing, late start fee]
video:
  youtube:
  bunny:
---
...
2. Review the generated sales orders
