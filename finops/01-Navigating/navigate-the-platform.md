...
summary:
  - "Click the **hamburger menu icon (☰)** to open the navigation pane."
  - "Select **Modules** to browse all functional areas, then drill down into the relevant module and submenu."
  - "Return to your dashboard at any time using the **Home icon**, or find any page via the **search bar**."
keywords: [navigate F&O, navigation pane, hamburger menu, modules, find a page, FNO navigation, Dynamics 365 navigate]
video:
  youtube:
  bunny:
---
