---
id: set-up-fee-categories
summary:
  - "Create fee categories in **Academic Management ▸ Setup ▸ Fee categories**, then link each category to the released product in **Product information management ▸ Products ▸ Released products** via the **Sell ▸ Activity ▸ Fee category** field."
  - "Categories related to Academic Management start with the letters AM."
keywords: [fee categories, fee category setup, released products, fee category link, AM categories, academic management fee]
video:
  youtube:
  bunny:
---
