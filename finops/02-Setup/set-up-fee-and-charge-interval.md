---
id: set-up-fee-and-charge-interval
summary:
  - "Open **Academic Management ▸ Setup ▸ Fee and Charge Interval**, click **New**, enter the interval ID, start/end dates, and number of intervals, then click **Generate**."
  - "For each period, set the description, start/end dates, due date, and click **Update unit quantity**. Then generate weeks and months for pro-rata support."
  - "The fee and charge interval is the link between students, fee schedule templates, and the fee generation batch — students without a matching interval are excluded from billing runs."
keywords: [fee and charge interval, billing interval, academic year dates, billing periods, pro rata, intervals setup]
video:
  youtube:
  bunny:
---
