---
id: set-up-academic-year
summary:
  - "Open **Academic Management ▸ Setup ▸ Academic year**, click **New**, enter the academic year code and description, select the Fee master list, then save."
  - "Click **Tuition fee items**, add the tuition fee item with Unit = Year and Quantity = 1, then save."
  - "The academic year code must match the grade code in the student management system."
keywords: [academic year setup, academic year configuration, grade setup, tuition fee item, fee master list, academic year code]
video:
  youtube:
  bunny:
---
...
1. Create the academic year record
   ...
   The **Sequence** number is assigned automatically and determines the order in which grades appear — it cannot be edited.

   ![Set Up Academic Year — the Academic year form with Academic year code, Description, and Fee master list fields](./images/set-up-academic-year-1.png)
...
2. Add tuition fee items
   ...
   ![Set Up Academic Year — the Tuition fee items panel with the new item row showing Item number and Unit](./images/set-up-academic-year-2.png)
