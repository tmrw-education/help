...
id: set-up-fee-type
summary:
  - "Open **Academic Management ▸ Setup ▸ Cashier receipt ▸ Fee type**, click **New**, enter the fee type code, account, tax group, and tax item group, then save."
  - "When a fee type is selected during cashier or miscellaneous receipt processing, the system automatically populates payment type, financial dimensions, and accounting postings."
keywords: [fee type setup, cashier receipt fee type, miscellaneous receipt, fee type configuration, account posting, tax group]
video:
  youtube:
  bunny:
---
