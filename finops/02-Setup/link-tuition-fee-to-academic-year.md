---
id: link-tuition-fee-to-academic-year
summary:
  - "Open the academic year record in **Academic Management ▸ Setup ▸ Academic year**, click **Tuition fee items**, add the tuition fee item with Unit and Quantity, then save."
  - "This link is required for enrolment deposit calculations — the system uses it to identify the tuition fee item and look up the correct annual price from the trade agreement."
keywords: [link tuition fee, academic year link, tuition fee item, enrolment deposit calculation, academic year tuition]
video:
  youtube:
  bunny:
---
