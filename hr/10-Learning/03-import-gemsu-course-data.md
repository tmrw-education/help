...
Alongside the live integration, a data entity is available for loading GEMSU course records from Excel. Use it for cutover, or to bring in historical course data that pre-dates the integration. Day-to-day course data arrives through the integration and does not need to be imported.
...
2. Open Data management
   ...
   In D365, go to **Data management** and create a new import project.
...
4. Run the import
   ...
   Run the import and review the results. Rows that fail are reported against the project with the reason, so you can correct the file and re-run just the failures.
