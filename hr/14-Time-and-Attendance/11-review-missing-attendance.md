...
An employee who punches in in the morning but never punches out in the evening leaves an incomplete day. The missing attendance form collects these so you can chase and correct them, rather than quietly producing an incorrect duration.
...
2. Read the exceptions
   ...
   Each row is a day when one half of the pair is missing: a punch in with no punch out, or a punch out with no punch in. Both cases are recorded as missing attendance.
