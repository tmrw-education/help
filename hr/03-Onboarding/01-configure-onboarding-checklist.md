---
id: configure-onboarding-checklist
summary:
  - "Go to **Modules ▸ Human Resources ▸ Task Management ▸ Onboarding checklists**."
  - "Select a checklist, click **Edit**, and configure tasks with owners and offset dates."
  - "Click **Save** to apply."
keywords: [onboarding, checklist, configure, setup, task management, new hire, onboarding tasks, task assignment, offset date]
video:
  youtube:
  bunny:
---
