---
id: set-onboarding-parameters
summary:
  - "Go to **Human Resources parameters** and open the **Recruitment** tab."
  - "Select the default **onboarding checklist** and set the number of days for completion."
  - "Click **Save**."
keywords: [HR parameters, onboarding parameters, default checklist, onboarding days, recruitment parameters, onboarding setup, system setup]
video:
  youtube:
  bunny:
---
...
4. Set the completion period
   ...
   ![The Human Resources parameters form on the Recruitment tab with the Onboarding checklist and Number of days fields highlighted](./images/set-onboarding-parameters-1.png)
