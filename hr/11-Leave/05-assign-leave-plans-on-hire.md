...
1. Set the calendar and leave plans on the staff level
   ...
   Open the **Staff levels** form (**Human resources ▸ Setup ▸ Staff levels**) and select the record you are configuring. Against each legal entity, select the **Calendar** and the **Leave plans** that employees at that staff level should be enrolled in. You can assign multiple plans.
...
4. Submit and approve the workflow
   ...
   Submit the action to the workflow and approve it. The action stays **Pending** until the workflow completes — wait for the status to move to completed before checking the enrolment.
