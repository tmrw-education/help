...
summary:
  - "In D365, go to **Human Resources ▸ Performance ▸ Setup ▸ Goal templates** — this is the library every review draws its goals from."
...
4. Add as many goals as you need
   ...
   There is no practical limit. Build out the full library before moving on — you can add more later, but doing it up front means your review templates are complete the first time.
