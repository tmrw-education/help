---
id: vendor-login-and-contract-review
summary:
   - "Sign in to the account with the login details provided by the school."
   - "Review the contract"
   - "Submit a counteroffer or modified contract if needed."
   - "Approve the contract."
keywords: [vendor login, vendor contract, vendor counteroffer, vendor counter offer, vendor modified contract, vendor contract approval]
video:
   youtube:
   bunny:
---
