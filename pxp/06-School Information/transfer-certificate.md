...
1. Select the prompt for a student transfer certificate
   ...
   Select the **School Information** tile from the home screen. Select the **Transfer Certificate** prompt. A list of your children's names will appear; choose the child leaving the school.
...
2. Complete the transfer certificate request form
   ...
   ![Transfer request form with the send arrow activated](./images/transfer-certificate-1.png)
