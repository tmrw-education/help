...
keywords: [approve overtime, team overtime, overtime tab, overtime approval, clock in clock out, total approved minutes, confirm approval, manager approval, ESS]
video:
  youtube:
  bunny:
---
...
Overtime worked by your team is raised for you to approve in ESS. Yours is the first of three approvals — HR and finance approve after you in D365 — so nothing goes to payroll on your approval alone.

1. Open the overtime tab

   In ESS, open the **Attendance** tile and go to the **Overtime** tab.

   ![The Overtime tab in ESS showing overtime entries awaiting approval](./images/approve-your-teams-overtime-1.png)
...
3. Check the entry
   ...
   Very short overruns won't be listed. HR sets a minimum number of minutes below which overtime isn't raised for approval at all.
...
5. Confirm
   ...
   You are asked to confirm the action. Click **Confirm**.

   ![The confirmation prompt shown when approving an overtime entry](./images/approve-your-teams-overtime-2.png)
