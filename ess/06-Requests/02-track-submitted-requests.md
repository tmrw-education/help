...
3. Check the status and feedback
   ...
   ![The HR request detail view showing the request status, HR Feedback field, and a Download link for an attached document](./images/track-submitted-requests-1.png)
