...
summary:
  ...
  - "Select the dependent; then the **Tuition fee concession** button activates."
  - "Check the data and complete the pop-up form. Click **Submit**."
...
2. Select the dependent
   ...
   ![Selected dependent with the tuition concession link activated](./images/submit-tuition-fee-request-1.png)
...
3. Complete the form
   ...
   ![Tuition fee concession request popup form](./images/submit-tuition-fee-request-2.png)
