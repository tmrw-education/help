---
id: manage-your-address
summary:
  - "Go to **Full Profile ▸ Address** tab."
  - "Click **Add New Address** to add, or the **pencil icon** to edit."
  - "Mark one address as **Primary Residence** and click **Submit**."
keywords: [address, home address, update address, add address, primary address, residential address, address management]
video:
  youtube:
  bunny:
---
...
1. Open the Address tab
   ...
   ![The Full Profile with the Address tab selected, showing the Add New Address button and existing address entries](./images/manage-your-address-1.png)
