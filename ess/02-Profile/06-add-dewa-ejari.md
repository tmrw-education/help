...
summary:
  ...
  - "Select **DEWA** or **Ejari** from the **Identification type** dropdown."
  - "Complete the fields, attach the documentation, and click **Submit**."
keywords: [DEWA, Ejari, Dubai Electricity, tenancy, utility, DEWA account, housing, Ejari registration]
video:
  youtube:
  bunny:
---
...
3. Select the document type
   ...
   ![The identification type dropdown open, showing DEWA and Ejari as selectable options alongside other document types](./images/add-dewa-ejari-1.png)
