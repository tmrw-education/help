...
summary:
  - "Go to **Full Profile ▸ Payment information** tab."
  - "Click **Add new payment method** and complete the bank account details."
  - "Set the account to **Active** and click **Submit**."
keywords: [payment information, bank account, bank details, IBAN, payroll, salary, payment method, bank account update]
video:
  youtube:
  bunny:
---
