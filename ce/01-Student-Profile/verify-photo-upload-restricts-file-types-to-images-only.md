...
# Verify photo upload restricts file types to images only
...
1. TODO — step title
   ...
   ![TODO — alt text describing the action](./images/verify-photo-upload-restricts-file-types-to-images-only-1.png)
