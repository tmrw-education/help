...
id: assign-approvers
summary:
  - "Open the approval matrix for the event type you want to change."
  - "Open the **Approval matrix detail** row for that level."
  - "Change the approver, then **Save & Close**."
keywords: [assign event approvers, change who approves an event, event approver setup, swap an approver, approval order number]
video:
  youtube:
  bunny:
---
