...
3. Describe the concern
   ...
   **Sentiment** (Positive, Neutral or Negative) and the **Priority**.
   ...
   ![The wellbeing note form showing note type, sentiment, priority and description](./images/create-a-wellbeing-note-and-share-2.png)
...
5. Save
   ...
   ![The saved wellbeing note with its automatically created wellbeing case](./images/create-a-wellbeing-note-and-share-3.png)
