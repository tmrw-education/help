---
draft: true
id: create-notice-rsvp-enabled
summary:
  - "Create the notice under **Communications** and go to the **Details** tab."
  - "Turn on **RSVP required**, then set the date and time of the activity."
  - "Set the audience and save — recipients can now confirm attendance."
keywords: [notice with RSVP, RSVP required notice, confirm attendance notice, invite parents to an event, notice invitation, RSVP notice CE]
video:
  youtube:
  bunny:
---
...
3. Set the date and time
   ...
   Enter the event date and the start and end times. This is what goes
   into the calendar invite.

   ![A notice with RSVP required turned on and the event date and time set](./images/create-a-notice-with-rsvp-enabled-1.png)

4. Set the audience and save

   Choose the audience and save. Recipients see the RSVP option when
