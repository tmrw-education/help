---
id: track-resolve-note
summary:
  - "On the **Wellbeing** landing page or the **Active notes** tab, **tick** one or more notes."
  - "In the batch action bar, click **Mark Resolved**, **Mark Cancelled**, or **Mark Active**."
  - "A toast confirms the change and offers **Undo**."
keywords: [resolve a case, close a wellbeing note, cancel a case, reopen a case, mark resolved, mark cancelled, change case status, finish a wellbeing note, undo status change]
video:
  youtube:
  bunny:
---
