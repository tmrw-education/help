---
id: see-student-wellbeing-notes
summary:
  - "Open the student's profile and select the **Wellbeing** tab."
  - "See **Staff to notify** plus the **Wellbeing notes** table — **Date**, **Title**, **Priority**, **Status**."
  - "Search and page the list; the tab is read-only."
keywords: [student wellbeing notes, wellbeing tab, pastoral notes for a student, see a student's notes, student profile wellbeing, wellbeing history, all notes for a student]
video:
  youtube:
  bunny:
---
