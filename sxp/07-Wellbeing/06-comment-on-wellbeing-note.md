---
id: comment-on-wellbeing-note
summary:
  - "On the case detail page, in the **Comments** tile click the **+**."
  - "Add a **Title** and **Notes**, and optionally attach a file."
  - "Click **Save** to log it in the case timeline."
keywords: [add comment, comment on case, wellbeing comment, log follow up, case timeline, add note to case, pastoral comment, comment on wellbeing note]
video:
  youtube:
  bunny:
---
