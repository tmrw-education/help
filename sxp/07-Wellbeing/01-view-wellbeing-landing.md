---
id: view-wellbeing-landing
summary:
  - "Open **Wellbeing** from the navigation."
  - "A **Metrics** strip sits across the top, then your notes table below."
  - "Click a **Case title** to open a case, or a **Student name** to open the profile."
keywords: [wellbeing landing page, wellbeing overview, view wellbeing, pastoral dashboard, wellbeing metrics, my wellbeing notes, open a wellbeing case, wellbeing notes list]
video:
  youtube:
  bunny:
---
