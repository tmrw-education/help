---
id: coordinate-muster
summary:
  - "During an active emergency, coordinators open the **Emergency coordinator** or **Muster coordinator** page to watch the headcount live."
  - "**Emergency coordinator** shows every class and muster point, plus a **Cleared classes** table."
  - "**Muster coordinator** shows just your own muster point's headcount and cleared classes."
  - "These pages only exist while an emergency is active."
keywords: [coordinate the muster, muster point, emergency coordinator, muster coordinator, evacuation headcount, lockdown roll, who is missing, emergency attendance, account for students, cleared classes]
video:
  youtube:
  bunny:
---
