---
id: resolve-attendance-marks
summary:
  - "On the **Attendance overview**, use the officer tab bar to work requests and marks."
  - "Open **Unresolved attendance**, **Correction request**, or **Leave requests** and action the list."
  - "Change a cell to open the **category picker** and pick a specific reason, then submit."
keywords: [resolve attendance, attendance officer, correction request, unresolved attendance, leave requests, approve leave, fix a mark, change approved absence, edit past roll, category picker, resolved requests]
video:
  youtube:
  bunny:
---
