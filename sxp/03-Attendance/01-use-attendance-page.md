---
id: use-attendance-page
summary:
  - "Open **Attendance** from the navigation to land on your teacher page."
  - "Three stat cards sit above your day's **calendar**."
  - "Click a class on the calendar to open its roll."
  - "Each card's **Show top 10** opens a list of those students."
keywords: [attendance page, attendance landing page, take the roll, my classes today, late students, absent students, top 10 students, attendance calendar, open a class roll, attendance stat cards]
video:
  youtube:
  bunny:
---
