---
id: view-attendance-analytics
summary:
  - "Open **Attendance analytics** from **View analytics** on the Attendance page, or a trends tile."
  - "Read the **at-risk banner**, the **Attendance rate** card, and the **Trends** charts."
  - "Filter the charts **by class** and the **at-risk table** by **year group** and risk level."
keywords: [attendance analytics, attendance rate, students at risk, at-risk table, attendance trends, absence timing, absence by day, late students, unexcused absences, attendance patterns]
video:
  youtube:
  bunny:
---
