---
id: take-emergency-roll
summary:
  - "When a leader declares an emergency, your open roll flips to the **Emergency roll** (red **Emergency roll** tag)."
  - "Mark each student **Present** or **Missing**, or use the header **mark all** action."
  - "Click **Submit** to send your class's status — you can submit what you have, even part-marked."
keywords: [emergency roll, evacuation, fire drill, lockdown, headcount, muster, mark present, mark missing, account for students, emergency attendance]
video:
  youtube:
  bunny:
---
