...
summary:
  ...
  - "Pick a day in the popover to load that session's roll."
  - "Past sessions open **read-only** for teachers — review the marks, but the cells are locked."
keywords: [view a past roll, change the roll date, see yesterday's attendance, look up a previous session, attendance date picker, past attendance, review an old roll, change attendance date]
video:
  youtube:
  bunny:
---
