---
id: mark-whole-column
summary:
  - "On the roll, click the **action control on today's column header**."
  - "Choose **mark all Present** or **mark all Absent** to set every student at once."
  - "Use **reset** to clear your pending marks, then click **Submit**."
keywords: [mark all present, mark all absent, bulk mark roll, mark whole class, mark everyone present, reset roll, clear marks, fast roll, mark column at once]
video:
  youtube:
  bunny:
---
