---
id: find-open-class-roll
summary:
  - "On the **Attendance overview** dashboard, use the **Class rolls** table."
  - "**Search** by class or teacher and **filter** by year group."
  - "Set a **date range** from the calendar trigger to find a past session."
  - "Click a **class name** to open that roll."
keywords: [find a class roll, open any class roll, class rolls table, search for a class, filter by year group, attendance date range, leader open roll, officer open roll, drill into a roll, whole-school rolls]
video:
  youtube:
  bunny:
---
