...
summary:
  - "School-leader-only — the red **Emergency** button lives in the **top app toolbar**, not on an Attendance page."
  - "In the **Initiate emergency protocol** dialog, pick an **Incident type** (required) and optionally a **Message to staff**."
  - "Click **Confirm** to flip every teacher's roll into a stripped-down **Emergency roll**."
keywords: [start an emergency, declare an emergency, emergency roll, evacuation, lockdown, fire drill, emergency attendance, muster, headcount, initiate emergency protocol]
video:
  youtube:
  bunny:
---
