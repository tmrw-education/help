...
id: review-a-request
summary:
  - "In **All requests**, click **Review** on a **Pending** request."
  - "Read the submitted details, then choose **Approve**, **Decline** or **Request more info**."
  - "**Decline** and **Request more info** require **notes** the requester can read back."
  - "A **venue conflict** disables **Approve** until you resolve it."
keywords: [review activity request, approve excursion, decline camp request, request more info, activity coordinator, sign off activity, approve request, reject request, review notes, pending request, venue conflict]
video:
  youtube:
  bunny:
---
