...
id: request-a-camp
summary:
  - "On the **Activities** overview, click **Request activity**, choose **Camp**, and **Submit**."
  - "Work through the four steps: **Activity details → Resource booking → Risk management → Review and submit**."
  - "On the last step, click **Submit** — the camp shows as **Pending** for a coordinator to approve."
keywords: [request a camp, plan a camp, school camp, overnight trip, book a camp, camp risk assessment, submit camp request, off-site camp]
video:
  youtube:
  bunny:
---
