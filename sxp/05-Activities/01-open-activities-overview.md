---
id: open-activities-overview
summary:
  - "Open **Activities** from the navigation."
  - "Three action cards sit across the top — **Request venue**, **Calendar view**, **Request activity**."
  - "Below them are the tabs — your request queue, **Booking status**, **All venues** and more."
keywords: [open activities, activities overview, activities hub, excursions page, view activities, activities dashboard, request activity page, activity requests list]
video:
  youtube:
  bunny:
---
