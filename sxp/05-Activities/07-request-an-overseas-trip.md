---
id: request-an-overseas-trip
summary:
  - "On the **Activities** overview, click **Request activity**, choose **Overseas trip**, and **Submit**."
  - "Work the four steps: **Activity details → Resource booking → Risk management → Review and submit**."
  - "Overseas trips add a **maximum-attendees cap** and a **wait list**, plus **insurance** and a required **local emergency number**."
  - "On the last step, click **Submit** — the request lands on the overview as **Pending**."
keywords: [overseas trip, international trip, request an overseas trip, plan a trip abroad, school trip overseas, wait list, maximum attendees, insurance, packing list, activity request]
video:
  youtube:
  bunny:
---
