...
id: request-a-venue
summary:
  - "On the **Activities** overview, click **Request venue**."
  - "Work through **Venue details**, **Risk management**, then **Review and submit**."
  - "Click **Submit** to send the venue request."
keywords: [request a venue, add a new venue, venue not in approved venues, new venue request, venue risk assessment, public liability insurance venue, request a location for a trip]
video:
  youtube:
  bunny:
---
