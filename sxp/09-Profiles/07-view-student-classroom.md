---
id: view-student-classroom
summary:
  - "Open a student profile, then the **Classroom management** tab."
  - "Read **Learning programs** for curriculum, mode and a **Courses** table."
  - "Check the **Attendance percentage** and the **Disability and learning difficulties** detail."
keywords: [student courses, learning program, attendance percentage, curriculum, timetable, learning mode, diagnosed disability, learning difficulty, learning disability document, classroom management, what classes a student takes]
video:
  youtube:
  bunny:
---
