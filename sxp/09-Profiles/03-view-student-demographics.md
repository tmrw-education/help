---
id: view-student-demographics
summary:
  - "Open the **Demographics** tab on a student profile for their fuller identity record."
  - "Read **Student details**, **Visa information** and **Enrolled siblings** — all read-only."
  - "A dash (**—**) means no value is on file, which is normal."
keywords: [student demographics, residential student, school transport, visa information, enrolled siblings, date of birth, nationality, academic year group, roll group, student identity]
video:
  youtube:
  bunny:
---
