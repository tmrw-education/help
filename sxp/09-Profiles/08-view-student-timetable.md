---
id: view-student-timetable
summary:
  - "On a student profile, open the **Timetable** tab to see what they have on today."
  - "**Today's Timetable** lists each class by **Period**, **Full class name**, **Room number** and **Start and end time**."
  - "The class happening right now carries a blue **Now** tag."
keywords: [student timetable, what class is a student in, where should a student be now, today's classes, student schedule, period room time, current lesson, find a student's room]
video:
  youtube:
  bunny:
---
