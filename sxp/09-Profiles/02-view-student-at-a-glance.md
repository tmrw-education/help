---
id: view-student-at-a-glance
summary:
  - "Click a **student's name** anywhere to open their profile on the **At a glance** tab."
  - "Read the **Student details** block, then check the four **alert icons** over the photo — custody, physical, learning, medical."
  - "Click an active (full-colour) icon for a pop-up; open any **Shared documents** (IEP, learning-disability, medical plan)."
keywords: [student profile, at a glance, student details, student alerts, custody alert, medical alert, learning alert, physical alert, alert icons, who can collect a student, IEP, shared documents, student photo, view student record]
video:
  youtube:
  bunny:
---
