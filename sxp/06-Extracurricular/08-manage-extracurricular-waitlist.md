---
id: manage-extracurricular-waitlist
summary:
  - "On the activity's **details** page, find the **Waitlist** table."
  - "**Tick** one or more students to bring up the batch bar."
  - "Use **Approve** to enrol them, or **Remove** to take them off."
keywords: [waitlist, extra-curricular waitlist, approve from waitlist, move off waitlist, club waitlist, team waitlist, enrol waitlisted student, remove from waitlist, ECA waitlist]
video:
  youtube:
  bunny:
---
