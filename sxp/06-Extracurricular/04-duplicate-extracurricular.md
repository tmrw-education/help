---
id: duplicate-extracurricular
summary:
  - "On an **Approved** activity, click the **Replicate** (duplicate) icon."
  - "The create flow opens pre-filled from that activity."
  - "Re-enter the **dates** and **registration window**, then **Submit**."
keywords: [duplicate extra-curricular, replicate activity, copy an activity, reuse an approved activity, clone a club, template from an existing activity, re-run an activity]
video:
  youtube:
  bunny:
---
