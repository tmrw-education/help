---
id: edit-delete-extracurricular-request
summary:
  - "On the **All requests** / **Your requests** tab, find a **New** or **Draft** request."
  - "Click the **Edit (pencil)** action to reopen it in the create flow, pre-filled."
  - "Click the **Delete (bin)** action, then confirm, to remove it."
keywords: [edit extra-curricular request, delete extra-curricular request, change a draft activity, remove a draft request, edit club request, delete club request, amend my request, scrap a draft]
video:
  youtube:
  bunny:
---
