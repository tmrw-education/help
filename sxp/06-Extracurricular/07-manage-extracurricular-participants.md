---
id: manage-extracurricular-participants
summary:
  - "Open an approved activity's **details** page and find the **Registered participants** table."
  - "**Search** by name, year group, or gender to find someone."
  - "Click a row's **bin** icon, then confirm in **Remove participant**, to take a student off."
keywords: [registered participants, remove participant, extra-curricular roster, club members, who's enrolled, activity enrolment, take a student off an activity, maximum places]
video:
  youtube:
  bunny:
---
