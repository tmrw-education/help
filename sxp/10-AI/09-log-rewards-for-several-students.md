---
id: log-rewards-for-several-students
summary:
  - "Prompt Felix with **create rewards for my students**."
  - "Select the students, then set one **value** — it applies to everyone selected."
  - "Change individuals if you need to, **Preview**, then **Send**."
keywords: [bulk rewards, log rewards for a class, reward several students, bulk consequence, multiple students reward, group reward, class rewards Felix]
video:
  youtube:
  bunny:
---
